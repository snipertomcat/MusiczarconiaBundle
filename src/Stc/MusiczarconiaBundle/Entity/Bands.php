...
class Bands
{
     ...
     * @ORM\PrePersist
     */
    public function prePersistBand()
    {
        // Add your code here
    }
     ...
     * @ORM\PostPersist
     */
    public function postPersistBand()
    {
        //if (!empty($this->contactIdC))
     ...
     * Add fosusers
     *
     * @param \Stc\MusiczarconiaBundle\Entity\FosUser $fosusers
     * @return Bands
     */
    public function addFosuser(\Stc\MusiczarconiaBundle\Entity\FosUser $fosusers)
    {
     ...
     * @param \Stc\MusiczarconiaBundle\Entity\FosUser $fosusers
     */
    public function removeFosuser(\Stc\MusiczarconiaBundle\Entity\FosUser $fosusers)
    {
